...
**🤖  RinAI is an open-source multimodal desktop agent that combines speech processing, LLMs, tool automation, state machines and NEAR Intents for cross-chain trading and limit order scheduling. Features include:**
...
* **NEAR Intents Integrations:** Integration with the NEAR Intents solver bus enables cross chain swaps on from a user's near wallet.
